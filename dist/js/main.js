...
function refreshPoints() {
  ...
  points_spr.position.set(50, import_shaku.default.gfx.canvas.height * 0.9);
}
...
function step() {
  ...
  if (!grabbing_card) {
    let cur_hovering_card = veg_hand.find((card) => posOverCard(import_shaku.default.input.mousePosition, card)) || null;
    if (!hovering_card) {
